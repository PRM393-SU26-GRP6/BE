...
namespace CourtManager.Infrastructure.Migrations
{
    ...
    [Migration("20260607162555_UpdateSeedDataWithEmailVerification")]
    partial class UpdateSeedDataWithEmailVerification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CourtManager.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmailConfirmed = true,
                            EmailVerifiedAt = new DateTime(2026, 6, 5, 0, 0, 0, 0, DateTimeKind.Utc),
                            FullName = "Lan Nguyen",
                            IsActive = true,
                            IsDeleted = false,
